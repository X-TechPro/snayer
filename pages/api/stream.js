...
export default async function handler(req, res) {
    ...
    // If the link is a vidsrc.co proxy, extract the 'u' param and inject it into index.html for playback
