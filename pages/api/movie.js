...
// Refactored movie API using centralized utilities
...
export default async function handler(req, res) {
    ...
    if (tmdb) {
        ...
        (async () => {
            ...
            await sniffStreamUrl({ tmdb, token: browserlessToken, type: 'movie', onStatus: (idx, status, url) => {
                statuses[idx] = status;
    ...
    let streamUrl;
    try {
        streamUrl = await sniffStreamUrl({ tmdb, token: browserlessToken, type: 'movie' });
    } catch (e) {
